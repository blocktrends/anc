            ...
            <div class="w-full mt-1 sm:mt-10 lg:mt-0 hidebrs xl:max-w-[50%]">
                ...
                <div class="xl:pl-8 sm:pl-0 w-full">
                        ...
                        <div class="accordion__content border-y border-[#29292E] overflow-hidden ">
                            ...
                            <div class="pb-7 pt-7 pl-12 lg:pl-16">
                                ...
                                <p class="accordion__body text-[#B6C3DA]  block text-md lg:pr-24">
                                Sim. Por se tratar de um Programa em que a ANCORD é parceira, o número de créditos do PEC será de 50 pontos no ano. Para cadastrar os pontos, o AI acessa sua área de credenciamento no PEC, faz o upload do Certificado do Programa CCA e a pontuação será creditada automaticamente.
                                 </p>
                        </div>
                ...
                <div class="xl:pl-8 sm:pl-0 w-full">
                        ...
                        <label for="fpanel-9" class="relative  pl-12 lg:pl-16 border-y border-[#29292E] block cursor-pointer text-white p-4 
                            text-sm sm:text-lg font-semibold pr-5">
                            Qual é o valor do Programa CCA? Quais são os meios de pagamento?
                        </label>
...
>
  <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
    <div class="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
      <div class="items-start flex flex-col max-xl:mt-10">
        <img  class=" shadow-sm overflow-hidden" src="../assets/imgs/people.png" alt="Pessoas Blocktrends" />
        
        <div
          class="text-white text-2xl tracking-tighter self-stretch whitespace-nowrap mt-3"
        >
          Ainda tem dúvidas?
        </div>
        <div class="text-zinc-500 hidebrs text-base self-stretch mt-3">
          Envie uma mensagem e<br /> converse conosco.
        </div>
      </div>
    </div>
    <div
